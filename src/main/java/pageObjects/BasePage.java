...
public abstract class BasePage {
	...
	/*
	 * abstract methods that child pages must implement each page defines how it
	 * confirms it's presence
	 */
	...
	/*
	 * reusable action methods which will be used throughout the framework
	 */
	...
	protected void clickElementWithJavascriptExecutor(WebElement element) {
	...
	// click radio button by value matching
