...
public class TC_24 extends BaseTest {
	...
	public void testTC_24(Map<String, String> data) {
		...
		shoppingCartPage.clickContinueOnCart();
		...
		Assert.assertTrue(checkoutPage.reviewYourOrder(), "Review your order is displayed correctly");
		...
		Assert.assertTrue(paymentPage.validateOrderConfirmation(), "Order has not been placed successfully");
